...
public class PetsPage {
    ...
    static JPanel createFooterPanel() {
        ...
        homeButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                homeButton.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));  // Muda para mão
            }

            @Override
            public void mouseExited(MouseEvent e) {
                homeButton.setCursor(Cursor.getDefaultCursor());  // Restaura o cursor padrão
            }
        });
    ...
    public static void start() {
        ...
        petsPanel.add(HomePage.createTopPanel(), BorderLayout.NORTH); // Adiciona o painel superior
