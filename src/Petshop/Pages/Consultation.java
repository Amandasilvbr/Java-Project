...
import Petshop.Utils.CustomDatePicker;
...
public class Consultation extends JFrame {
    ...
    public Consultation() {
        ...
        tableModel = new DefaultTableModel(new Object[]{"Descrição", "Data", "Hora", "Veterinário", "Nome do pet"}, 0);
    ...
    private void saveData() {
        ...
        consultations.add(new String[]{description, formattedDate, formattedTime, vet, petName});
    ...
    private void updateConsultationPanel(String description, String petName, String vet, String formattedDate, String formattedTime) {
        ...
        JPanel newCard = createCards(description, "Pet: " + petName, "Veterinário: " + vet, "Data: " + formattedDate, "Hora: " + formattedTime, 10, 10, 10, 10);
    ...
    private boolean temConsultaNoDia(int day, int month, int year) {
        ...
        for (String[] consulta : consultations) {
            try {
                Date consultaDate = sdf.parse(consulta[1]);
